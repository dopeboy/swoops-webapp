CREATE MATERIALIZED VIEW IF NOT EXISTS view_current_season_player_stats_5_tokens AS
...
CREATE UNIQUE INDEX ON view_current_season_player_stats_5_tokens (player_id);
