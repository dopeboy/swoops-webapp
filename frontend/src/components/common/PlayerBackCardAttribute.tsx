...
export const PlayerBackCardAttribute: React.FC<PlayerBackCardAttributeProps> = ({ title, value, isAttributeRevealed, isTopAttribute }) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center">
            ...
            <span className="text-white font-bold heading-two sm:heading-two pd-1.5xl:player-card-large pd-2xl:player-card-extra-large">
                {!isAttributeRevealed || value === '-' ? '??' : value}
            </span>
        </div>
    );
};
