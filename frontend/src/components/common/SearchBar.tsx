...
const SearchBar = (props): JSX.Element => {
    return (
        <div className="relative flex flex-wrap w-full lg:w-auto items-stretch grow">
            ...
            <input
                className="pl-3 h-12 bg-white/4 capitalize rounded-r-lg rounded-l-none text-white text-base font-display grow appearance-none  focus:outline focus:ring-indigo-500 focus:border-indigo-500  placeholder:text-white/32 focus:text-white"
