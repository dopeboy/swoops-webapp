...
export const TourneyTable: React.FC<TourneyTableProps> = ({ tournaments, loadingTournaments, reloadTournaments }): ReactElement => {
    return (
                        ...
                        {tournaments && tournaments.length > 0 && !loadingTournaments && (
                            <table className="min-w-full divide-y divide-gray-600">
                                ...
                                <tbody className="bg-white dark:bg-black divide-y divide-gray-600">
                                    {tournaments && tournaments.map((tournament) => <TournamentRow tournament={tournament} />)}
                                </tbody>
                            </table>
                        )}
