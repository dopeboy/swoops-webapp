        ...
        >
            <div className="flex flex-col justify-start">
                ...
                <div className="flex flex-col justify-start ml-4">
                    <text className="label-text text-white/64">Shooting Guard</text>
                    <text className="heading-three text-white">Will</text>
                    <text className="heading-three text-white">Slaprock</text>
