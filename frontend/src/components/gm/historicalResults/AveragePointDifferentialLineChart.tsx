...
interface AveragePointDifferentialLineChartData {
    date: string;
    'Average Differential': number;
    'Your Average Differential': number;
}
interface AveragePointDifferentialLineChartProps {
    title: string;
    chartData: AveragePointDifferentialLineChartData[];
}

export const AveragePointDifferentialLineChartWithFilters: React.FC<AveragePointDifferentialLineChartProps> = ({ title, chartData }) => {
    ...
    return (
        <div className="flex flex-col justify-center items-center border border-white/16 rounded-xl py-4 pr-6 mb-3 sm:mb-6">
            <Title className="pl-6">
                <span className="heading-three">{title}</span>
                <Legend
                    className="-mb-3 mt-2 w-full flex flex-row items-center justify-center gap-1"
                    categories={['Your Average Differential', 'Average Differential']}
                    colors={['rose', 'gray']}
                    dir="row"
                />
            </Title>
